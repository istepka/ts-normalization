...
Consumes the outputs of scripts/recompute_tsfm_scale_free_metrics.py and emits:
...
def main() -> None:
    ...
    final.to_csv(args.metrics_dir / "summary.csv")
    ...
    (args.metrics_dir / "paired_effects.json").write_text(json.dumps(effects, indent=2))
    ...
    (args.metrics_dir / "head_to_head.json").write_text(json.dumps(h2h, indent=2))
