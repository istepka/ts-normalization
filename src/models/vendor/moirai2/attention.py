...
class GroupedQueryAttention(nn.Module):
    ...
    def _get_var_id(
        ...
        query: torch.Tensor,
        key: torch.Tensor,
        query_var_id: Optional[torch.Tensor],
        kv_var_id: Optional[torch.Tensor],
    ...
    def _get_time_id(
        ...
        query: torch.Tensor,
        key: torch.Tensor,
        query_time_id: Optional[torch.Tensor],
        kv_time_id: Optional[torch.Tensor],
    ) -> tuple[Optional[torch.Tensor], Optional[torch.Tensor]]:
    ...
    def _update_attn_mask(
        ...
        query: torch.Tensor,
        key: torch.Tensor,
        query_var_id: Optional[torch.Tensor] = None,
        kv_var_id: Optional[torch.Tensor] = None,
        query_time_id: Optional[torch.Tensor] = None,
        kv_time_id: Optional[torch.Tensor] = None,
